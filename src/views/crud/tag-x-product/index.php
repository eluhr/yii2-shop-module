...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var eluhr\shop\models\search\TagXProduct $searchModel
*/

$this->title = Yii::t('shop', 'Tag X Products');
...
?>
<div class="giiant-crud tag-x-product-index">
