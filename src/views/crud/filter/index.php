...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var eluhr\shop\models\search\Filter $searchModel
*/
...
?>
<div class="giiant-crud filter-index">
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-random text-muted"></i> ' . Yii::t('shop', 'Tag X Filter'),
                                ...
                                [
                'url' => ['/shop/crud/tag/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('shop', 'Tag'),
            ],
