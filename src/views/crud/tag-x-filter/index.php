...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var eluhr\shop\models\search\TagXFilter $searchModel
*/

$this->title = Yii::t('shop', 'Tag X Filters');
...
?>
<div class="giiant-crud tag-x-filter-index">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('shop', 'Filter'),
            ],
                                [
                'url' => ['/shop/crud/tag/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('shop', 'Tag'),
            ],
