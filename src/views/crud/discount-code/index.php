...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var eluhr\shop\models\search\DiscountCode $searchModel
*/

$this->title = Yii::t('shop', 'Discount Codes');
...
?>
<div class="giiant-crud discount-code-index">
