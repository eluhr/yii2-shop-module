...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var eluhr\shop\models\search\Vat $searchModel
*/
...
?>
<div class="giiant-crud vat-index">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('shop', 'Variants'),
            ],
            ]
            ],
            'options' => [
