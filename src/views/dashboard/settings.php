    ...
    <div class="col-xs-12 col-md-6">
        <div class="box box-solid box-default">
            ...
            <div class="box-body">
                ...
                echo $form->field($setting, ShopSettings::SHOP_GENERAL_SHOW_SEARCH, ['template' => '{input} {label} {error}'])->checkbox(['data-input' => 'checkbox', 'data-group' => 'general', 'data-confirm-text' => Yii::t('shop', 'Are you sure you want to change this setting? This will hide/show the product filter in frontend'), 'class' => 'switch-input'], false);
